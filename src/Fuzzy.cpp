...
{               //-45, -40, -30, 0, 30, 40, 45
                //-41, -35, -20, 0, 20, 35, 41
    // float EFF[7]={-41, -30, -17, 0, 17, 30, 41};                          //摄像头误差分区
    // float DFF[7]={-31, -15, -7, 0, 7, 15, 31};                          //误差变化率分区
    // float UFF[7]={0, 296, 360, 380, 395, 435, 443};        
    float EFF[7]={-41, -30, -17, 0, 17, 30, 41};                          //摄像头误差分区
    float DFF[7]={-23, -11, -5, 0, 5, 11, 23};                          //误差变化率分区
    float UFF[7]={0, 249, 287, 357, 385, 435, 443};                 //限幅分区
...
////////规则激活
    ...
    if((*(PF+0))<=(*(DF+0)))    //求小       PF 和 DF 模拟量和隶属度分别比较
        (*(UF+0))=*(PF+0);
    else
        (*(UF+0))=(*(DF+0));
    if((*(PF+1))<=(*(DF+0)))
